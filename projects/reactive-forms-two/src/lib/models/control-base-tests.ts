...
export default function runControlBaseTestSuite(
  name: string,
  createControlBase: () => ControlBase
) {
  const IS_CONTROL_CONTAINER_TEST = name !== 'FormControl';
  ...
  describe(name, () => {
      ...
      describe('ValidationErrors', () => {
        ...
        it('should not modify errors for other ControlIds', async () => {
          ...
          expect(event1).toEqual({
            ...
            sideEffects: expect.arrayContaining(ERRORS_SIDE_EFFECTS),
          });
        });
    ...
    describe('markTouched', () => {
      it('true', async () => {
        ...
        const sideEffects = IS_CONTROL_CONTAINER_TEST
          ? ['containerTouched']
          : [];
    ...
    describe('markDirty', () => {
      it('true', async () => {
        ...
        const sideEffects = IS_CONTROL_CONTAINER_TEST ? ['containerDirty'] : [];
    ...
    describe('markDisabled', () => {
      it('true', async () => {
        ...
        expect(event1).toEqual({
          ...
          sideEffects: expect.arrayContaining([...sideEffects, 'status']),
        });
      });
