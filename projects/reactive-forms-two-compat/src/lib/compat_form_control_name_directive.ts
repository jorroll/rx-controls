  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SwCompatFormControlNameDirective),
    },
  ],
})
export class SwCompatFormControlNameDirective
  ...
  protected ngControl = new NgCompatFormControl(
    new FormControl(undefined, {
      id: Symbol(
        `NgCompatFormControlNameDirective-${SwCompatFormControlNameDirective.id++}`
      ),
    })
  );
